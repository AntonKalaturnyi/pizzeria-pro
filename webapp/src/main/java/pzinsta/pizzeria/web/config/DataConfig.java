    ...
    public LocalContainerEntityManagerFactoryBean entityManagerFactory() {
        ...
        factory.setJpaPropertyMap(
                ImmutableMap.of(
                        ...
                        "hibernate.postddl.auto", environment.getProperty("hibernate.postddl.auto"),
                        "hibernate.hbm2ddl.import_files_sql_extractor", environment.getProperty("hibernate.hbm2ddl.import_files_sql_extractor"),
                        "hibernate.postddl.import_files", environment.getProperty("hibernate.postddl.import_files")
                ));
        return factory;
    }
